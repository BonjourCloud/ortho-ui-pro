...
import { doctorProfile, services, testimonials, serviceCategories } from "@/data/mockData";

const stats = [
  { label: "Years Experience", value: `${doctorProfile.yearsExperience}+` },
  { label: "Happy Patients", value: `${doctorProfile.happyPatients.toLocaleString()}+` },
  { label: "Surgeries", value: `${doctorProfile.surgeriesCompleted.toLocaleString()}+` },
  { label: "Branches", value: `${doctorProfile.branches}` },
];
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground leading-tight mb-5">
                Move Freely.
                <br />
                <span className="text-gradient-gold">Live Fully.</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-3">
                <Link
                  to="/book"
                  className="inline-flex items-center gap-2 rounded-lg bg-accent px-6 py-3 text-sm font-semibold text-accent-foreground transition-all hover:opacity-90 shadow-lg"
                >
                  Book Appointment <ArrowRight size={16} />
                </Link>
                <Link
                  to="/services"
                  className="inline-flex items-center gap-2 rounded-lg border border-primary-foreground/30 px-6 py-3 text-sm font-semibold text-primary-foreground transition-all hover:bg-primary-foreground/10"
                >
                  Our Services
                </Link>
              </div>
            ...
            >
              <div className="relative">
                <img
                  src={heroImage}
                  alt="Dr. Srivanth - Orthopedic Surgeon in Hyderabad"
      ...
      <section className="py-16 md:py-24">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mt-2">Why Choose Dr. Srivanth?</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {testimonials.map((t, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="bg-card/10 backdrop-blur-md rounded-xl p-6 border border-primary-foreground/10"
              >
        ...
        <div className="container">
          <div className="bg-gold-light rounded-2xl p-8 md:p-14 text-center">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto mb-8">
              Book a consultation with Dr. Srivanth today. Insurance accepted, EMI options available.
            </p>
