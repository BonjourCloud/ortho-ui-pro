-- Add Extracorporeal Shockwave Therapy under Physiotherapy section with full content
...
BEGIN
  ...
  -- Add Extracorporeal Shockwave Therapy under Physiotherapy (Level 1)
  ...
  <p class="mb-6">If you''re struggling with chronic pain, explore if ESWT can be a solution for you. Contact Dr. Srivanth''s Orthopedic Clinic today to schedule an appointment and discuss your treatment options. We are committed to helping you find relief and get back to living an active life.</p>
    ...
    DO UPDATE SET
      ...
      updated_at = NOW()
    RETURNING id INTO eswt_id;
    
    RAISE NOTICE '✓ Extracorporeal Shockwave Therapy content added/updated successfully with ID: %', eswt_id;
