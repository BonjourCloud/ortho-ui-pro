-- Fix SLAP Lesion page - force clean content overwrite
...
BEGIN
  ...
  <img src="/images/treatments/slap-lesion/slap-tear-anatomy.jpg" alt="SLAP Tear diagram showing Superior Labrum Anterior and Posterior Tear" class="w-full h-auto rounded-xl border shadow-lg my-8" />
  ...
  <ul class="list-disc pl-6 mb-4 space-y-2">
    ...
    <li>Physiotherapy focusing on rotator cuff strengthening, scapular stabilization, and gradual return to activity</li>
  </ul>
  ...
  <ul class="list-disc pl-6 mb-6 space-y-2">
    ...
    <li><strong>Athlete-Focused Care:</strong> Specialized rehabilitation for sports professionals and active individuals.</li>
  ...
  <p class="mb-6">Don''t let a SLAP tear keep you from the activities you love. Contact Dr. Srivanth''s Orthopedic Clinic today to get an accurate diagnosis and the right treatment plan for your recovery.</p>
    ...
    IF page_id IS NOT NULL THEN
      RAISE NOTICE '✓ SLAP Lesion content fixed - duplicate image removed';
      RAISE NOTICE 'URL: /orthopaedics/slap-lesion';
    ELSE
      RAISE NOTICE '✗ SLAP Lesion page not found';
    END IF;
  ELSE
